<pre>// app/client/purchase/ewallet.js
import { sendApiRequest } from '../engsel.js';

export async function executeEwalletPurchase({ apiKey, tokens, items, paymentMethod, walletNumber, paymentFor = "BUY_PACKAGE", overwriteAmount = -1, tokenConfirmationIdx = 0, amountIdx = -1, env }) {
